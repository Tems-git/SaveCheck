...
| State | Значение |
|-------|----------|
| 🟢 **real** | Промо цената е най-ниската за последните 30 дни — реална икономия |
...
| ⚪ **unverified** | Обявена промоция, но има под 10 наблюдения за 90 дни — недостатъчна история (`VerdictConfig.min_sample_90`; различен праг от филтъра за влизане в `products.js`) |
...
63 unit тестове (aggregates, verdict, snapshot, history, alerts, ingest parser).
